    ...
    internal class MatchManager : MonoBehaviour
    {
        ...
        private static void Init() {
            if(robotsMatchData == null) { 
                ...
                robotsMatchData.Add(new PlayerMatchData(robot1.GetName(), robot1, null));
                robotsMatchData.Add(new PlayerMatchData(robot2.GetName(), robot2, null));
            }
        }

        private static void InstantiateRobots() {
            foreach (PlayerMatchData r in robotsMatchData) {
